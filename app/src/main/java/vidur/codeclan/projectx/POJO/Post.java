...
public class Post {
     ...
     * @param image
     */
    public Post(String body, String category, Integer id, String image, Integer likes, String link, java.lang.Object subCategory, String timestamp, String title, Integer userId) {
        super();
        this.body = body;
